<?php
    /*
     * Template Name: Template Residences
     */
?>

<?php  get_header(); ?>

<?php $data = get_field("residences_hero"); ?>
...
<?php } ?>  
    ...
    <?php $data = get_field("residences_block");?>
    <?php if($data) { ?>
        <?php 
    ...
    <?php $data = get_field('bottom_description'); ?>  
    <?php if($data) { ?>
        <section class="block_description last_description">
            <p>
                <?php echo $data;?>
            </p>
        </section>
    ...
    <?php $data = get_field("residences_content_footer"); ?>
