...
<?php $data = get_field("experience_hero"); ?>
...
<?php } ?>  
        ...
        <?php $data = get_field('experience_top_description'); ?>
        <?php if($data !="") { ?>
    ...
    <?php $data = get_field("experience_block");?>
    <?php if($data) { ?>
        <?php 
            foreach($data as $key => $value)
            {
                ...
                else //Full width banner
                {
                    ...
                    ?>
                    <section class="full_bg full_bg_common" style="background: url('<?php echo $img_full; ?>'); background-repeat: no-repeat;
                        background-position: center center;
                            background-size: cover;">
                            <div class="container">
    ...
    <?php $data = get_field("experience_content_footer"); ?>
